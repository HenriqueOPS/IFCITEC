                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-md-offset-1 col-xs-9">
                            <div class="input-group">
                                ...
                                <div class="form-group ">
                                    <label class="control-label">Início</label>
                                    <input type="datetime-local" class="form-control datepicker" name="relatorio_abertura" value="{{ strftime('%Y-%m-%dT%H:%M:%S', strtotime($dados->relatorio_abertura)) }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-md-offset-1 col-xs-9">
                            <div class="input-group">
                                ...
                                <div class="form-group ">
                                    <label class="control-label">Fim</label>
                                    <input type="datetime-local" class="form-control datepicker" name="relatorio_fechamento" value="{{ strftime('%Y-%m-%dT%H:%M:%S', strtotime($dados->relatorio_fechamento)) }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
