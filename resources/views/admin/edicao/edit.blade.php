                    ...
                    <form method="post" action="{{ route('edicao') }}">
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1 text-center">
                                ...
                                <span>Durante esse período será possivel acessar o sistema como Autor, Avaliador,
                                    Homologador e Organizador</span>
                            </div>
                            ...
                            <div class="col-md-4 col-md-offset-1 col-xs-9 col-xs-offset-1">
                                <div class="input-group{{ $errors->has('feira_abertura') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="datetime-local" class="form-control datepicker" name="feira_abertura"
                            ...
                            <div class="col-md-4 col-md-offset-1 col-xs-9 col-xs-offset-1">
                                <div class="input-group{{ $errors->has('feira_fechamento') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="datetime-local" class="form-control datepicker" name="feira_fechamento"
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox"
                                                            ...
                                                            name="nivel_id[]"
                                                            class="checkboxNivel checkboxNivel{{ $nivel->id }}" checked>
                                                        {{ $nivel->nivel }}
                                                    </label>
                                                </div>
                                            @else
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1 col-xs-10 text-center">
                                ...
                                <span>Durante esse período será possivel se inscrever para atuar como voluntário durante a
                                    feira</span>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1 text-center">
                                    ...
                                    <span>Durante esse período será possivel realizar o credenciamento no evento (Dia da
                                        Feira)</span>
                                </div>

                                <div class="col-md-4 col-md-offset-1 col-xs-9 col-xs-offset-1">
                                    <div
                                        class="input-group{{ $errors->has('credenciamento_abertura') ? ' has-error' : '' }}">
                                        <span class="input-group-addon">
                                            <i class="material-icons">today</i>
                                        </span>
                                        <div class="form-group ">
                                ...
                                <div class="col-md-4 col-md-offset-1 col-xs-9 col-xs-offset-1">
                                    <div
                                        class="input-group{{ $errors->has('credenciamento_fechamento') ? ' has-error' : '' }}">
                                        <span class="input-group-addon">
                                            <i class="material-icons">today</i>
                                        </span>
                                        <div class="form-group ">
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1 text-center">
                                ...
                                <span>Durante esse período será possivel avaliar os projetos homologados (Dia da
                                    Feira)</span>
                            </div>
