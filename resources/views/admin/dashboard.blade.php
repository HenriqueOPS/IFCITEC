...
@section('content')
    ...
    <div id="template-dashboard" style="display: none">
        ...
        <hr/>
        <div class="row">
            <h5 style="font-size: 2vw; font-weight: 500;">FALTA AVALIAR</h5>
...
@section('css')
    <style>
        ...
        .grafico li .barra .preenchido.vermelho {
            background: #f04732;
        }

        .grafico li .barra .preenchido.verde {
            background: #458e33;
        }
        ...
        function atualizaDados() {
            $.get("/dashboard/data", function(data) {
                ...
                setTimeout(function() {
                    ...
                    // gráfico Projetos
                    $('.preenchido.percenProjetosJaAvaliados').css('width', ((projetos.avaliados / projetos
                        .numProjetos) * 100) + '%');
                    $('.preenchido.percenProjetosUmaAvaliacao').css('width', ((projetos.umaAvalicao /
                        projetos.numProjetos) * 100) + '%');
                    $('.preenchido.percenProjetosFaltaAvaliar').css('width', ((projetos.naoAvaliados /
                        projetos.numProjetos) * 100) + '%');

                    // gráfico Avaliadores
                    $('.preenchido.percenAvaliadoresPresentes').css('width', ((avaliadores.presentes /
                        avaliadores.numAvaliadores) * 100) + '%');
                    $('.preenchido.percenAvaliadoresNaoPresentes').css('width', ((avaliadores.naoPresentes /
                        avaliadores.numAvaliadores) * 100) + '%');
